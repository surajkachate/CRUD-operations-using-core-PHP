...
<body>
  <div class="container-fluid">
    <h2 class="text-center">Welcome to Mytable</h2>
    <p class="datatable design text-center">CRUD operation using php, jQuery, AJAX, Datatable, and Bootstrap</p>
    <div class="row">
      <div class="container">
        <div class="btnAdd">
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (status == 'true') {
              ...
              // table.cell(parseInt(trid) - 1,2).data(age);
              var button = '<td><a href="javascript:void();" data-id="' + id + '" class="btn btn-info btn-sm editbtn">Edit</a>  <a href="#!"  data-id="' + id + '"  class="btn btn-danger btn-sm deleteBtn">Delete</a></td>';
              var row = table.row("[id='" + trid + "']");
              row.row("[id='" + trid + "']").data([id, username, age, button]);
      ...
      if (confirm("Are you sure you want to delete this User?")) {
        $.ajax({
          ...
          success: function(data) {
            ...
            status = json.status;
            if (status == 'success') {
              var row = table.row("#" + id).remove().draw(false);
              // The above line removes the row and redraws the table without reloading the data
            } else {
              alert('Failed');
              return;
            }
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control" id="ageField" name="age">
              </div>
            </div>
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control" id="addAgeField" name="age">
              </div>
            </div>
            <div class="text-center">
              <button type="submit" class="btn btn-primary">Submit</button>
